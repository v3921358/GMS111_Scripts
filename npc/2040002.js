...
function action(mode, type, selection) {
	...
	if (mode == 0 && status == 0) {
		cm.sendOk("我明白。這是非常可以理解的，考慮到你將面臨內部一個非常危險的怪物的事實。如果你覺得心臟的改變，那麼請你跟我說話。我確信可以從別人像你使用的幫助。");
		cm.dispose();
		return;
	...
	if (status == 5){
		if (dh == null || entry == false) {
			...
			cm.sendOk("謝謝你 #h #, 我們得到了 #b#t4031094##k 回並銷毀從另一個邪惡的怪物。值得慶幸的是，我們還沒有找到一個這樣的，因為。我不知道怎麼感謝你幫助我們這麼多。希望你在#m220000000#過得愉快!");
			cm.dispose();
		} else {
