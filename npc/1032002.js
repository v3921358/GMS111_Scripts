...
function action(mode, type, selection) {
	...
	if (status == 1 && mode == 1) {
		...
		if (selectedType == 3){ //wand refine
			var selStr = "魔杖？ 喜歡放在口袋裏的小武器嗎？ 你要找哪種類型的?#b";
		...
		if (selectedType == 4){ //staff refine
			var selStr = "長杖？ 一個人力量的偉大象徵！ 你想做什麼？#b";
