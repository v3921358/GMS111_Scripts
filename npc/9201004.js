...
function action(mode, type, selection) {
	...
	if (status == 0 && mode == 0 || status == 2 && mode == 0) {
		cm.dispose();
		return;
		}
	if (mode == 1) {
