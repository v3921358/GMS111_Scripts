...
function end(mode, type, selection) {
	...
	if (qm.getQuestStatus(20102) == 0) {
		...
		qm.sendAcceptDecline("你已經做好選擇了嗎？ 選擇之後是不能反悔的，所以務必慎重。 你真的要#b選擇炎術士之路#k嗎？\r\n\r\n#fUI/UIWindow.img/QuestIcon/4/0# \r\n#i1142066#   #t1142066#\r\n#i1372043#   #t1372043#");
		}
		}
	if (status == 1){
		...
		qm.sendNext("現在你已經是炎術士了。 如果你想變得更強，可以在内容窗（S鍵）中提升相應的内容。 如果覺得太難，可以使用#b自動分配#k。 這對還不熟悉魔法師職業的人而言非常有用。");
		}
	if (status == 2)
		qm.sendNext("另外，我給你分配了一些#bSP#k，你可以打開#bSkill選單#k學習技能。 當然，一開始並不是所有技能都可以學習，有些技能必須先學習其它技能後才可以學習。");
	if (status == 3)
		qm.sendNextPrev("你要記住，和初心者的時候不同，成為炎術士之後如果死亡，會損失之前積累的部分經驗值。");
	if (status == 4)
