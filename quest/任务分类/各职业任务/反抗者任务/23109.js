...
function end(mode, type, selection) {
	...
	if (status == 0) {
	if (qm.getQuestStatus(23109) == 0) {
		qm.forceStartQuest();
		qm.dispose();
	} else if (qm.getQuestStatus(23109) == 1) {
	...
	if (status == 2)
		qm.sendAcceptDecline("總之我負責的是對外任務，今後你和我見面的次數可能要比你的轉職教官#b#p2151004##k還要多。 在黑色之翼被趕出這個地方之前，執行任務的時候一定要做好萬全的準備。\r\n\r\n#fUI/UIWindow.img/QuestIcon/4/0#   \r\n\r\n#fUI/UIWindow.img/QuestIcon/8/0# 200 exp");
	if (status == 3){
